			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?=site_url("surat")?>" class="btn btn-social btn-flat btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Kembali Ke Daftar Surat">
					...
					<div class="box-body">
						<form action="" id="main" name="main" method="POST" class="form-horizontal">
							<div class="form-group">
								<label for="nik"  class="col-sm-3 control-label">NIK / Nama Penduduk</label>
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="alasan"  class="col-sm-3 control-label">Permohonan KTP</label>
								<div class="col-sm-6 col-lg-4">
					...
					<div class='modal-dialog'>
						<div class='modal-content'>
							...
							<div class='modal-body small'>
								...
								<ol>
                	<li>Surat keterangan permohonan kartu keterangan penduduk untuk pemohon</li>
									<li>Lampiran F-1.15 FORMULIR PERMOHOHAN KARTU TANDA PENDUDUK (KTP) WARGA NEGARA INDONESIA untuk pemohon</li>
								</ol>
