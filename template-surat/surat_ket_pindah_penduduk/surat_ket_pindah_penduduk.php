<script>
   $(document).ready(function() {
      $('#form-data-alamat').html($('#form-data-tujuan').html());
   });

   function pilih_format_surat(kode_format) {
      $('#kode_format').val(kode_format);
      if (kode_format == 'f108') {
         $('#form-data-alamat').html($('#form-data-asal').html());
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-4">
                           <select class="form-control input-sm" id="pakai_format" name="pakai_format" style="width:100%;" onchange="pilih_format_surat($(this).val());">
                              ...
                              <option value="f108">F-1.08 (Pindah Datang)</option>
                              <option value="bukan_f108" selected>F-1.23, F-1.25, F-1.29, F-1.34 (Pindah Keluar)</option>
                           </select>
                        </div>
                     </div>
...
<div id="form-data-tujuan" style="display: none;">
   <div class="form-group">
...
<div id="form-data-asal" style="display: none;">
   <div class="form-group">
      <label for="alamat_tujuan" class="col-sm-3 control-label">Alamat Asal</label>
      <div class="input-group col-sm-8">
         <div class="col-sm-12">
            <input id="alamat_tujuan" name="alamat_tujuan" class="form-control input-sm required <?= jecho($cek_anjungan, TRUE, 'kbvtext'); ?>" type="text" placeholder="Alamat Asal"></input>
         </div>
      </div>
   </div>
   <div class="form-group">
      <label for="rt_tujuan" class="col-sm-3 control-label">RT/RW/Dusun Asal</label>
      <div class="input-group col-sm-8">
         <div class="col-sm-2">
            <input id="rt_tujuan" name="rt_tujuan" class="form-control input-sm required <?= jecho($cek_anjungan, TRUE, 'kbvtext'); ?>" type="text" placeholder="RT"></input>
         </div>
   ...
   <div class="form-group">
      <label for="desa_tujuan" class="col-sm-3 control-label">Desa/Kelurahan Asal</label>
      <div class="input-group col-sm-8">
         <div class="col-sm-12">
            <input id="desa_tujuan" name="desa_tujuan" class="form-control input-sm" type="hidden" data-awal="<?= $lokasi['nama_desa']; ?>">
            <input id="desa_tujuan_show" class="form-control input-sm required <?= jecho($cek_anjungan, TRUE, 'kbvtext'); ?>" type="text" placeholder="Desa/Kelurahan" onchange="$('#desa_tujuan').val($(this).val());">
   ...
   <div class="form-group">
      <label for="kecamatan_tujuan" class="col-sm-3 control-label">Kec/Kab/Prop Asal</label>
      <div class="input-group col-sm-8">
         <div class="col-sm-2">
            <input id="kecamatan_tujuan" name="kecamatan_tujuan" type="hidden" data-awal="<?= $lokasi['nama_kecamatan']; ?>" />
            <input id="kecamatan_tujuan_show" class="form-control input-sm required <?= jecho($cek_anjungan, TRUE, 'kbvtext'); ?>" type="text" placeholder="Kecamatan " onchange="$('#kecamatan_tujuan').val($(this).val());">
