<?php foreach ($this->list_setting as $setting): ?>
	<?php if (($_SESSION['username'] != 'administrator' && $setting->key != 'web_theme' && $setting->key != 'covid_data' && $setting->key != 'covid_desa' && $setting->key != 'sebutan_desa' && $setting->key != 'api_opendk_server' && $setting->key != 'api_opendk_key' && $setting->key != 'api_opendk_user' && $setting->key != 'api_opendk_password' && $setting->key != 'tgl_data_lengkap' && $setting->key != 'tgl_data_lengkap_aktif' && $setting->key != 'layanan_opendesa_token' && $setting->key != 'enable_track' && $setting->key != 'google_key' && $setting->key != 'offline_mode' && $setting->key != 'libreoffice_path' && $setting->key != 'timezone' && $setting->key != 'token_opensid' ) || $_SESSION['username'] == 'administrator') : ?>
