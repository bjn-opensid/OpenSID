                ...
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs">
                    <?php if($_SESSION['username']=='administrator') : ?>
                      <li <?php if ($act_tab == 1) : ?>class="active" <?php endif ?>><a href="<?= site_url('database/export') ?>">Ekspor Database</a></li>
                    <?php endif; ?>
                    ...
                    <li <?php if ($act_tab==7): ?>class="active"<?php endif ?>><a href="<?= site_url('database/sinkron_tab')?>">Sinkron Kecamatan</a></li>
                    <?php if($_SESSION['username']=='administrator') : ?>
