...
INSERT INTO `setting_aplikasi` (`id`, `key`, `value`, `keterangan`, `jenis`, `kategori`) VALUES (12, 'offline_mode', '1', 'Apakah modul web akan ditampilkan atau tidak', 'option-kode', '');
...
#shell
cp desa-contoh/upload/user_pict/kuser.png /
cp desa-contoh/upload/user_pict/wuser.png /
rm cache/*
